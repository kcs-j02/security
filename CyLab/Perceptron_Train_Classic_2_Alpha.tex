...
% ===== cover =====
\cover{Perceptron Train Classic 2 Alpha}{SyLab}{小林智輝}
% =================
...
\begin{verbatim}
  ...
  before the flag is revealed. 
  The dataset is still linearly separable, 
  but it is less toy-like and the separation is less obvious. 
  Dial in a rate, trigger a run, and the interface animates each step.
\end{verbatim}
